...
def displayResults(opt,pdb,dssp):
	...
	if (opt.output):
		...
		for i in range(0,len(dssp)):
			...
			print("{:>5d}{:>5d}{:>2s}{:>2s}{:>2s}{:>3s}{:>1s}{:>1s}{:>3s}{:>9.3f}{:>6.1f}{:>6.1f}{:>6.1f}{:>6.1f}{:>7.1f}{:>7.1f}{:>7.1f}"\
				.format(l['index'],l['res_nb'],l['chain'],l['aa'],l['structure'],l['3-turns']['res'],l['4-turns']['res'],l['5-turns']['res'],\
